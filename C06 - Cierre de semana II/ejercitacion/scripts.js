...
let felinos = [
  ...
  {
  foto: "./imagenes/pantera-negra.jpg",
...
function crearCard  (felino, contenedor){
...
let card = document.createElement('div')
  ...
  foto.setAttribute('src', felino.foto);
  nombre.innerText = felino.nombre;
  descripcion.innerText = felino.descripcion;  
